...
{
    #define IOC_PAD_FUNC_CONFIG(periph, pad, ioc_func) do { HPM_IOC->PAD[pad].FUNC_CTL = ioc_func; } while (0)
 
    if (ptr == HPM_MCAN0) {
        IOC_PAD_FUNC_CONFIG(0, IOC_PAD_PB00, IOC_PB00_FUNC_CTL_MCAN0_TXD);
        IOC_PAD_FUNC_CONFIG(0, IOC_PAD_PB01, IOC_PB01_FUNC_CTL_MCAN0_RXD);

    } else if (ptr == HPM_MCAN1) {
        IOC_PAD_FUNC_CONFIG(1, IOC_PAD_PB05, IOC_PB05_FUNC_CTL_MCAN1_TXD);
        IOC_PAD_FUNC_CONFIG(1, IOC_PAD_PB04, IOC_PB04_FUNC_CTL_MCAN1_RXD);

    } else if (ptr == HPM_MCAN2) {
        IOC_PAD_FUNC_CONFIG(2, IOC_PAD_PB08, IOC_PB08_FUNC_CTL_MCAN2_TXD);
        IOC_PAD_FUNC_CONFIG(2, IOC_PAD_PB09, IOC_PB09_FUNC_CTL_MCAN2_RXD);

    } else if (ptr == HPM_MCAN3) {
        IOC_PAD_FUNC_CONFIG(3, IOC_PAD_PC15, IOC_PC15_FUNC_CTL_MCAN3_TXD);
        IOC_PAD_FUNC_CONFIG(3, IOC_PAD_PC14, IOC_PC14_FUNC_CTL_MCAN3_RXD);

    } else if (ptr == HPM_MCAN4) {
        IOC_PAD_FUNC_CONFIG(4, IOC_PAD_PC16, IOC_PC16_FUNC_CTL_MCAN4_TXD);
        IOC_PAD_FUNC_CONFIG(4, IOC_PAD_PC17, IOC_PC17_FUNC_CTL_MCAN4_RXD);

    } else if (ptr == HPM_MCAN5) {
        IOC_PAD_FUNC_CONFIG(5, IOC_PAD_PC21, IOC_PC21_FUNC_CTL_MCAN5_TXD);
        IOC_PAD_FUNC_CONFIG(5, IOC_PAD_PC20, IOC_PC20_FUNC_CTL_MCAN5_RXD);

    } else if (ptr == HPM_MCAN6) {
        IOC_PAD_FUNC_CONFIG(6, IOC_PAD_PC24, IOC_PC24_FUNC_CTL_MCAN6_TXD);
        IOC_PAD_FUNC_CONFIG(6, IOC_PAD_PC25, IOC_PC25_FUNC_CTL_MCAN6_RXD);

    } else if (ptr == HPM_MCAN7) {
        IOC_PAD_FUNC_CONFIG(7, IOC_PAD_PC31, IOC_PC31_FUNC_CTL_MCAN7_TXD);
        IOC_PAD_FUNC_CONFIG(7, IOC_PAD_PC30, IOC_PC30_FUNC_CTL_MCAN7_RXD);
...
void init_esc_pins(void)
{
    ...
    HPM_IOC->PAD[IOC_PAD_PE04].FUNC_CTL = IOC_PE04_FUNC_CTL_ESC0_CTR_2; /* LED_RUN */
    HPM_IOC->PAD[IOC_PAD_PE05].FUNC_CTL = IOC_PE05_FUNC_CTL_ESC0_CTR_3; /* LED_ERR */
